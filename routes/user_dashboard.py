...
def index():
    ...
    # Calcula o ranking geral de todos os membros ativos com a mesma regra exata
    ...
    # ORDENAÇÃO IDÊNTICA AO MASTER E AO LÍDER:
    # 1º Maior número de presenças (-x["total"])
    # 2º Maior porcentagem (-x["porcentagem"])
    # 3º Nome em ordem alfabética (x["nome"]) para desempate
